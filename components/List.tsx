        ...
        <Modal
                ...
                <Modal.Body>
                        ...
                        <input type={previsionDateInputType} placeholder='Data de previsão da tarefa'
                            onClick={e => setPrevisionDateInputType('date')} 
                            onBlur={e => !e.target.value ? setPrevisionDateInputType('text') : false}
                        ...
                        <input type={finishDateInputType} placeholder='Data de conclusão'
                            onClick={e => setFinishDateInputType('date')} 
                            onBlur={e => !e.target.value ? setFinishDateInputType('text') : false}
                ...
                <Modal.Footer>
                    <div className='button col-12'>
                        <button
                            disabled={loading}
                            onClick={updateTask}
                        >   {loading? "Loading..." : "Atualizar"}</button>
